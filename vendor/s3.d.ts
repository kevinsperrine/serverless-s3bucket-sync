declare module 's3' {
  ...
  interface CreateClientOptions {
     ...
     * optional. leave blank if you provide s3Client.
     See AWS SDK documentation for available options which are passed to new S3():
  ...
  interface S3Client {
     ...
     */
    deleteObjects(
      s3Params: S3.Types.DeleteObjectsRequest
    ): DeleteObjectsEventEmitter;
